...
class ModelNet40_C(Dataset):
    ...
    def __init__(self,
                ...
                split = 'test',
                corruption = 'distortion_rbf', # "background" "cutout" "density" "density_inc" "distortion" "distortion_rbf" "distortion_rbf_inv" "gaussian" "impulse" "rotation" "shear" "uniform" "upsampling"  "occlusion" "lidar"
                severity = 5,
                transform=None,
                transformc=None,
                shapley = False,
